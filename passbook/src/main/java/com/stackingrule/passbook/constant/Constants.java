...
public class Constants {
    ...
    /** 用户数的 redis key **/
    public static final String USER_COUNT_REDIS_KEY = "stackingule-user-count";
    ...
    public class UserTable {
        ...
        /** User HBase 表名 **/
        public static final String TABLE_NAME = "passbook:user";
    ...
    public class PassTemplateTable {
        ...
        /** PassTemplate 表名 **/
        public static final String TABLE_NAME = "passbook:passtemplate";
    ...
    public class PassTable {
        ...
        /** Pass HBase 表名 **/
        public static final String TABLE_NAME = "passbook:pass";
